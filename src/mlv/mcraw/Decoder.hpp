...
namespace motioncam {
    ...
    public:
        ...
        // Direct accessors to sorted video/audio offset tables (added for libmcraw C API)
        const std::vector<BufferOffset>& getVideoOffsets() const { return mOffsets; }
        const std::vector<BufferOffset>& getAudioOffsets() const { return mAudioOffsets; }
